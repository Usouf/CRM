...
from .models import *
from .forms import OrderForm, CreateUserForm, CustomerForm, ProductForm, UploadPdfForm
...
def createProducts(request):
    ProductFormSet = modelformset_factory(Product, fields = ('name', 'price', 'category', 'tag'), extra = 5)
...
def uploadPdf(request):
    UploadFormSet = modelformset_factory(FileUpload, fields = ('title', 'file',))
    formset = UploadFormSet(queryset = FileUpload.objects.none())
